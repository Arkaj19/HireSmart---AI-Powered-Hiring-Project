...
async def send_rejection_email(to_email: str, candidate_name: str, position: str):
    ...
    Thank you for applying for the position of {position} at GyanSys.
    After careful evaluation, we will not be moving forward at this time.
...
async def send_shortlist_email(to_email: str, candidate_name: str, position: str, test_link: str = None):
    ...
    Congratulations! You are shortlisted for the position of {position}.

    Please complete the test using the link below:
    {test_link}
